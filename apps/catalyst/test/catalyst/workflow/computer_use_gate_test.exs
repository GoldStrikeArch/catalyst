defmodule Catalyst.Workflow.ComputerUseGateTest do
  ...
  test "the built-in app-layer tools are gated, and fetch is not" do
    with_backend(true)
    ...
    builtins = ToolRegistry.default_tools()
    builtin_config = %{tools: builtins, tool_source: builtins, opts: []}
