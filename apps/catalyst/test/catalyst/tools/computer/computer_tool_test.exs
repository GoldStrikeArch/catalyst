defmodule Catalyst.Tools.ComputerToolTest do
  ...
  test "computer is a gated, sequential builtin tool" do
    assert Computer in Registry.default_tools()
    assert {:ok, entry} = Registry.fetch_entry(Registry.default_tools(), "computer")
