defmodule Catalyst.Tools.ShellSessionTest do
  ...
  describe "capability gating" do
    ...
    test "shell_session ships in the bundled tool set as a sequential gated tool" do
      refute ShellSession in Catalyst.Tools.Registry.default_tools()
      assert ShellSession in Catalyst.Extensions.tools()
